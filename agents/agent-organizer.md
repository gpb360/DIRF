...
- When the host provides a model catalog, suggest the lowest reported cost tier that declares each required capability.
...
- Keep model advice diagnostic: never invoke a model, monitor a session, guess pricing, or authorize spend.
